          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="h4 text-center fw-bold mx-3 mb-4">Recupera tu password</p>
                <form>
                  <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Cuenta</label>
                    <input type="email" id="zf_email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Ingrese su cuenta de correo">
                  </div>
                  <a href="./enviar-email" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Aceptar</a><!-- id="btnGuardar" name="btnGuardar" onClick="btnGuardarOnClick()" -->
                  <div class="d-flex align-items-center justify-content-center">
                    <p class="fs-4 mb-0 fw-bold">Ya tienes tu Cuenta ?</p>
