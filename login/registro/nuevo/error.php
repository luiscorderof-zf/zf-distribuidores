<?php function show_PageWeb($swLogin) { ?>
<!doctype html>
<html lang="es">
<head>
  <meta charset="utf-8">
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                <a href="/" class="text-nowrap logo-img text-center d-block py-3 w-100 mb-2">
                ...
                <p class="h4 text-center fw-bold mx-3 mb-4">Se presento un error !</p>
                <a href="../../../login" class="btn btn-secondary w-100 py-8 fs-4 mb-2 rounded-2">Aceptar</a>
                <a href="../../registro" class="btn btn-primary w-100 py-8 fs-4 mb-2 rounded-2">Reintentar</a>
                <!-- id="btnGuardar" name="btnGuardar" onClick="btnGuardarOnClick()" -->
              </div>
            </div>
            <br/>
          </div>
